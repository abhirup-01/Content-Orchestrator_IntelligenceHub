        ...
        <>
          ...
          <div className="fd-meta-grid">
            ...
            <div className="fd-meta-item">
              ...
              <div className="fd-meta-value">{new Date(data.fetched_at).toUTCString()}</div>
            </div>
          </div>
      ...
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        {!done ? (
          <>
            ...
            <div className="modal__meta"><span className="modal__label">Timestamp</span><span className="modal__meta-val">{new Date().toUTCString()}</span></div>

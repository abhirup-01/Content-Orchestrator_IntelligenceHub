...
export default function BrandIntelligenceProfile({ documents = [], onProfileChange }) {
  ...
  // Bubble every profile-state change up to the parent so it can react to
  // per-section accept/edit/flag without re-fetching. The explicit
  // onProfileChange calls inside runIngestion / clearProfile still fire,
  // this just adds coverage for the common case (accept/edit/flag updates
  // setProfile but didn't notify the parent).
  useEffect(() => {
